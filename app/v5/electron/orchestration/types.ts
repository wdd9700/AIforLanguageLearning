/**
 * @fileoverview 服务编排类型定义 (Service Orchestration Types)
 * @description
 * 该文件定义了服务编排系统的核心数据结构和接口。
 * 
 * 主要类型包括：
 * 1. 服务配置与状态 (ServiceConfig, ServiceInstance, ServiceStatus)
 * 2. 路由与管道 (RoutingRule, PipelineConfig, PipelineStep)
 * 3. 处理上下文与结果 (ProcessingContext, ProcessingResult)
 * 4. 编排器配置 (OrchestratorConfig)
 * 5. 监控与指标 (Metrics, HealthCheckResult)
 * 
