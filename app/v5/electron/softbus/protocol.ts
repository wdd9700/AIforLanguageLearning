/**
 * @fileoverview 软总线协议层 (Softbus Protocol Layer)
 * @description
 * 该模块实现了软总线的消息编解码协议。
 * 
 * 帧格式 (Frame Format)：
 ...
 * 
 * 主要功能包括：
 * 1. Varint 编解码 (encodeVarint, decodeVarint)：实现 LEB128 变长整数编码
 * 2. 消息编解码 (encodeMessage, decodeMessage)：实现完整的消息帧序列化与反序列化
 * 3. 辅助工具 (generateMsgId, createErrorMessage)：生成 ID 和错误消息
 * 
 * @author AI for Foreign Language Learning Team
 * @lastModified 2025-01
 */

import { Message, MessageHeader, MessageType, PROTOCOL_VERSION, ErrorCode } from './types.js';
